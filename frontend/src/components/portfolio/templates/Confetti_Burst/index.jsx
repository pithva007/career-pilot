...
/**
 * Confetti Burst Portfolio Template
 * Category: Animated / Motion
 * Description: Celebration-style confetti bursts when sections come into view or on button clicks. Colorful particle explosions. Festive, joyful aesthetic.
 */
    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center p-8 font-sans">
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="p-8 border-2 border-dashed border-cyan-500/40 rounded-2xl bg-gray-900/50 backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-bold text-gray-200 mb-3">Confetti Burst Template</h2>
          <p className="text-gray-400 mb-6 leading-relaxed">
            Celebration-style confetti bursts when sections come into view or on button clicks. Colorful particle explosions. Festive, joyful aesthetic.
          </p>
