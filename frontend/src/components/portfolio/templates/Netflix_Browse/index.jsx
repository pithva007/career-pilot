 ...
 * Description: Netflix browse UI with horizontal carousels of project cards, hover expansion with preview details, featured hero banner at top, dark background.
 */
